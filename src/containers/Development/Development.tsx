        ...
        <div className="Development">
            ...
            <div className="p-4 Code">
                ...
                <p className="F-Code mb-3">
                    {'<'}
                    <span style={{ color: 'red' }}>p</span>
                    {'>'} With a mathematical background, I have always excelled in problem solving. It was a revalation
                    to discover that web development was a skill that would satisfy both sides of my brain. {'</'}
                    <span style={{ color: 'red' }}>p</span>
                    {'>'}
                </p>
            </div>
