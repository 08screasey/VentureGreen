  ...
  window.scrollTo(0, 0)
	...
	return (<div className="Contact">
		<div className="Content px-2 mt-3">
			...
			<p className="F-OldStandard">Whether you're looking to hire a new web developer, needing to update your product images or even just reaching out because you think there's something I could do better, I'd love to hear from you!</p>
			<p className="F-OldStandard">If you're interested in what I do I'm always excited to collaborate or share whatever knowledge I've picked up on my travels.</p>
			<p className="F-OldStandard">Get in contact by sending me an email. Or, alternatively feel free to get in touch through any of my social media links.</p>
			...
			<a rel="noopener noreferrer" href="mailto:test@test.com" target="_blank">
				...
				<a rel="noopener noreferrer" href="https://www.instagram.com/venturegreenphotography/" target="_blank">
				<div className="blob green">		
			...
			<a rel="noopener noreferrer" href="https://www.facebook.com/sam.creasey1" target="_blank">
				...
				<a rel="noopener noreferrer" href="https://www.linkedin.com/in/sam-creasey-056b371b7/" target="_blank">
				<div className="blob green">	
