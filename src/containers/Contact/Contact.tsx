    ...
    <div className="Contact">
      <div className="Content px-2 mt-3">
        ...
        <p className="F-OldStandard">
          Whether you're looking to hire a new web developer, needing to update
          your product images or even just reaching out because you think
          there's something I could do better, I'd love to hear from you!
        </p>
        <p className="F-OldStandard">
          If you're interested in what I do I'm always excited to collaborate or
          share whatever knowledge I've picked up on my travels.
        </p>
        <p className="F-OldStandard">
          Get in contact by sending me an email. Or, alternatively feel free to
          get in touch through any of my social media links.
        </p>
