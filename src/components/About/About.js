	...
	return (
		<div className="About">
			...
			<div className="F-OldStandard AboutText">
				...
				<p>My portfolio is a showcase of everything I have taught myself. I am always tenacious in my quest to learn more, even if that meant bringing my laptop to the ski hill.</p>
