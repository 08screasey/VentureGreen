    ...
    return (
        <div className="About">
            ...
            <div className="F-OldStandard AboutText">
                ...
                <p>
                    Eventually I felt as though I had even more to offer, and discovered that web development was
                    scratching an itch for problem solving I'd had since graduating, allowing me to combine creativity
                    with my natural analytical skillset.
                </p>
                <p>
                ...
                <p>
                    Combining 7 years of hospitality work experience, an eternal drive for self-improvement, a rich
                    array of outdoor interests and a vocation for development encapsulates exactly what makes me, me!{' '}
                </p>
                <small>
