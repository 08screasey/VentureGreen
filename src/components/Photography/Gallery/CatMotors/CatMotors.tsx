...
export const CatMotors = ({ onImageClick }: ImageGalleryProps) => {
    ...
    return (
        <LazyLoadComponent>
            <GalleryLayout onClick={(i) => onImageClick(i, images)} header="Cat Motors" images={images}>
                Based in Chiang Mai, Cat Motors are a motorbike rental company who were set up by travellers with the
