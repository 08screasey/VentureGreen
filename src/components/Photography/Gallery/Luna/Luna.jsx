  ...
  return (
    <LazyLoadComponent>
      <GalleryLayout
        ...
        images={images}
      >
        In the quiet mountain town of Jasper, Alberta Luna & The Moon became
        more than just an idea. Filled with creative motivation, Olivia crafted
        her ideas into reality, and each one is carefully hand-made with the
        love of an independent artist. These scrunchies and headbands are made
        with 100% organic materials, sourced from within Canada as much as
        possible. They are a perfect gift for anyone, and great to hold your
        hair in place while you do your morning sun salutations.{" "}
      </GalleryLayout>
    </LazyLoadComponent>
  );
};
