...
export const Gemma = ({ onImageClick }: ImageGalleryProps) => {
    ...
    return (
        <LazyLoadComponent>
            <GalleryLayout onClick={(i) => onImageClick(i, images)} header="Gemma: Aerial" images={images}>
                Tucked away in an old church building, there are people dancing in the shadows. The circus community at
