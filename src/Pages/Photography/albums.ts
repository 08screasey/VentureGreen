...
export const GEMMA_ALBUM: Album = {
    ...
    coverArt: { src: '/cover-art/gemma.jpg' },
    images: [
...
export const CAT_MOTORS_ALBUM: Album = {
    ...
    coverArt: { src: '/cover-art/cat-motors.jpg' },
    images: [
...
export const CLIMATE_GALLERY: Album = {
    ...
    coverArt: { src: '/cover-art/climate.jpg' },
    images: [
...
your hair in place while you do your morning sun salutations.`,
    coverArt: { src: '/cover-art/luna.jpg' },
    images: [
...
three!`,
    coverArt: { src: '/cover-art/sprout.jpg' },
    images: [
...
const TRAVEL_ALBUMS = {
    header: 'Travel',
    coverArt: { src: '/cover-art/travel.jpg' },
    albums: [OCEANIA_ALBUM, ASIA_ALBUM, EUROPE_ALBUM, CANADA_ALBUM],
};
const CLIENT_ALBUMS = {
    header: 'Client',
    coverArt: { src: '/cover-art/client.jpg' },
